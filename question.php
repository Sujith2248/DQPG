        ...
        <div class="bottom">
            ...
            <div class="box">
                <form name="login" action="signupscript.php" method="post" class="form" onsubmit="return validateForm()">
                    <input type="text" name="Fname" placeholder="code"><br>
                    <input type="text" name="Lname" placeholder="subject id"><br>
                    <input type="text" name="contact" placeholder="exam name"><br>
                    <input type="text" name="email" placeholder="department"><br>
                    <input type="password" name="password" placeholder="semester"><br>
